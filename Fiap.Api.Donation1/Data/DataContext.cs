    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<TipoProdutoModel>().HasData(
                new TipoProdutoModel(1, "Celular", "Descriçao para celular"),
                new TipoProdutoModel(2, "Tvs", "Descriçao para Tvs"),
                new TipoProdutoModel(3, "Ar-condicionado", "Descriçao para ar-condicionado")
            );
            modelBuilder.Entity<UsuarioModel>().HasData(
                new UsuarioModel(1, "sa@fiap.com.br", "Super Admin", "123456", "admin"),
                new UsuarioModel(2, "joao@fiap.com.br", "Joao", "123456", "admin"),
                new UsuarioModel(3, "flavio@fiap.com.br", "Flavio", "123456", "admin")
            );
